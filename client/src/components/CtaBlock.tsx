...
function CtaBlock() {
  ...
  return (
    <div className="flex justify-center items-center min-h-[77vh] bg-[#0d0f14]">
        <div className="rounded-3xl flex flex-col justify-center items-center gap-5 border border-[#1e3020] min-h-[55vh] max-w-[65%] bg-linear-to-br from-[#111820] to-[#0f1a14] transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,255,62,0.15)] hover:-translate-y-1">
...
is closer than you think.</div>
            ...
            <button onClick={NavigateToLinkDrop} className="cursor-pointer hover:bg-lime-300 transition-all duration-300 hover:shadow-[0_0_15px_rgba(168,255,62,0.3)] hover:scale-105 bg-[#a8ff3e] rounded-lg p-2">Start for free — no sign up needed →</button>
        </div>
    </div>
  )
}
